...
<div id="layoutBusquedaNormal_seguimiento_despacho4" class="easyui-layout" data-options="fit:true">
 ...
 <?php
   $respuesta='<table url="'.DIR_LOCAL_DATAGRID_SEGUIMIENTO_DESPACHO.'dtg_PerfilesUsu.php" id="tblVisorBusqueda_seguimiento_despacho4" style="width:100%;height:100%"
	 ...
	 ">
		<thead>
			<tr >
				...
				<th data-options="field:\'cmp4VisorBusqueda_seguimiento_despacho\'" style="width:25%"><b>Email</b></th>
				<th data-options="field:\'cmp3VisorBusqueda_seguimiento_despacho\'" style="width:30%"><b>Institución</b></th>
   ...
   ?>
	...
	.datagrid-btable{
		width:100%;
         ...
         <script>
			$(function (){
				$('#tblVisorBusqueda_seguimiento_despacho4').datagrid({striped:$(this)});
				//$('#tblVisorBusqueda_seguimiento_despacho').datagrid('regionSelect');
				$('#tblVisorBusqueda_seguimiento_despacho4').datagrid('getPanel').removeClass('lines-both lines-no lines-right lines-bottom').addClass("lines-no");
				$('#tblVisorBusqueda_seguimiento_despacho4').datagrid('enableFilter', [
			...
			function abrirFormulario(){
				var row = $('#tblVisorBusqueda_seguimiento_despacho4').datagrid('getSelected');
				if (row){
						var p = $('#layoutBusquedaNormal_seguimiento_despacho4').layout('panel','center');
						p.panel('refresh','seguimiento_despacho/src/contenido/admin/perfilesusuadd.php?_id_registro_persona='+row.cmp0VisorBusqueda_seguimiento_despacho);
				}else{
