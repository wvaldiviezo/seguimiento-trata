...
<div id="layoutBusquedaNormal_seguimiento_despacho7" class="easyui-layout" data-options="fit:true">
 ...
 <?php
   $respuesta='<table url="'.DIR_LOCAL_DATAGRID_SEGUIMIENTO_DESPACHO.'dtg_Objgen.php" id="tblVisorBusqueda_seguimiento_despacho7" style="width:100%;height:100%"
	...
	onClickRow:function(){ abrirFormulario();},
	 ...
	 ">
		<thead>
			<tr >
				<th data-options="field:\'cmp0VisorBusqueda_seguimiento_despacho\'" style="width:10%"><b>Código</b></th>
				<th data-options="field:\'cmp1VisorBusqueda_seguimiento_despacho\'" style="width:6%"><b>Año</b></th>
				<th data-options="field:\'cmp2VisorBusqueda_seguimiento_despacho\'" style="width:30%"><b>Eje</b></th>
				<th data-options="field:\'cmp3VisorBusqueda_seguimiento_despacho\'" style="width:58%"><b>Objetivo General</b></th>
			</tr>
		</thead>
	...
	.datagrid-btable{
		width:100%;
         ...
         <script>
			...
			$(function (){
				$('#tblVisorBusqueda_seguimiento_despacho7').datagrid({striped:$(this)});
				//$('#tblVisorBusqueda_seguimiento_despacho').datagrid('regionSelect');
				$('#tblVisorBusqueda_seguimiento_despacho7').datagrid('getPanel').removeClass('lines-both lines-no lines-right lines-bottom').addClass("lines-no");
				$('#tblVisorBusqueda_seguimiento_despacho7').datagrid('enableFilter', [
			...
			function abrirFormulario(){
				var row = $('#tblVisorBusqueda_seguimiento_despacho7').datagrid('getSelected');
				if (row){
						var p = $('#layoutBusquedaNormal_seguimiento_despacho7').layout('panel','center');
						p.panel('refresh','seguimiento_despacho/src/contenido/admin/objgenadd.php?_id_registro_seguimiento='+row.cmp0VisorBusqueda_seguimiento_despacho);
				}else{
