...
<div id="layoutBusquedaNormal_seguimiento_despacho2" class="easyui-layout" data-options="fit:true">
 ...
 <?php
   $respuesta='<table url="'.DIR_LOCAL_DATAGRID_SEGUIMIENTO_DESPACHO.'dtg_Usuarios.php" id="tblVisorBusqueda_seguimiento_despacho2" style="width:100%;height:100%"
   ...
   ?>
	...
	.datagrid-btable{
		width:100%;
         ...
         <script>
			$(function (){
				$('#tblVisorBusqueda_seguimiento_despacho2').datagrid({striped:$(this)});
				//$('#tblVisorBusqueda_seguimiento_despacho').datagrid('regionSelect');
				$('#tblVisorBusqueda_seguimiento_despacho2').datagrid('getPanel').removeClass('lines-both lines-no lines-right lines-bottom').addClass("lines-no");
				$('#tblVisorBusqueda_seguimiento_despacho2').datagrid('enableFilter', [
			...
			function abrirFormulario(){
				var row = $('#tblVisorBusqueda_seguimiento_despacho2').datagrid('getSelected');
				if (row){
						var p = $('#layoutBusquedaNormal_seguimiento_despacho2').layout('panel','center');
						p.panel('refresh','seguimiento_despacho/src/contenido/admin/usuariosadd.php?_id_registro_seguimiento='+row.cmp0VisorBusqueda_seguimiento_despacho);
				}else{
