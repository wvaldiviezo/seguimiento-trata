...
<div id="layoutBusquedaNormal_seguimiento_despacho8" class="easyui-layout" data-options="fit:true">
 ...
 <?php
   $respuesta='<table url="'.DIR_LOCAL_DATAGRID_SEGUIMIENTO_DESPACHO.'dtg_Institucion.php" id="tblVisorBusqueda_seguimiento_despacho8" style="width:100%;height:100%"
	 ...
	 ">
		<thead>
			<tr >
				...
				<th data-options="field:\'cmp1VisorBusqueda_seguimiento_despacho\'" style="width:75%"><b>Institución</b></th>
			</tr>
		</thead>
         ...
         <script>
			...
			function abrirFormulario(){
				...
				if (row){
						...
						p.panel('refresh','seguimiento_despacho/src/contenido/admin/institucionadd.php?_id_registro_seguimiento='+row.cmp0VisorBusqueda_seguimiento_despacho);
				}else{
