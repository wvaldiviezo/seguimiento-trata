...
<div id="layoutBusquedaNormal_seguimiento_despacho3" class="easyui-layout" data-options="fit:true">
 ...
 <?php
   $respuesta='<table url="'.DIR_LOCAL_DATAGRID_SEGUIMIENTO_DESPACHO.'dtg_PerfilesUsuEdit.php" id="tblVisorBusqueda_seguimiento_despacho3" style="width:100%;height:100%"
	...
	onClickRow:function(){ abrirFormulario();},
	 ...
	 ">
		<thead>
			<tr >
				<th data-options="field:\'cmp0VisorBusqueda_seguimiento_despacho\'" style="width:6%"><b>Código</b></th>
				<th data-options="field:\'cmp1VisorBusqueda_seguimiento_despacho\'" style="width:25%"><b>Apellidos</b></th>
				<th data-options="field:\'cmp2VisorBusqueda_seguimiento_despacho\'" style="width:25%"><b>Nombres</b></th>
				<th data-options="field:\'cmp3VisorBusqueda_seguimiento_despacho\'" style="width:25%"><b>Perfil</b></th>
				<th data-options="field:\'cmp4VisorBusqueda_seguimiento_despacho\'" style="width:30%"><b>Institución</b></th>
				<th data-options="field:\'cmp5VisorBusqueda_seguimiento_despacho\'" style="width:15%"><b>Teléfono</b></th>
				<th data-options="field:\'cmp6VisorBusqueda_seguimiento_despacho\'" style="width:13%"><b>Extensión</b></th>
				<th data-options="field:\'cmp7VisorBusqueda_seguimiento_despacho\'" style="width:13%"><b>Celular</b></th>
			</tr>
		</thead>
   ...
   ?>
	...
	.datagrid-btable{
		width:100%;
         ...
         <script>
			$(function (){
				$('#tblVisorBusqueda_seguimiento_despacho3').datagrid({striped:$(this)});
				//$('#tblVisorBusqueda_seguimiento_despacho').datagrid('regionSelect');
				$('#tblVisorBusqueda_seguimiento_despacho3').datagrid('getPanel').removeClass('lines-both lines-no lines-right lines-bottom').addClass("lines-no");
				$('#tblVisorBusqueda_seguimiento_despacho3').datagrid('enableFilter', [
                ...
                $("[name=cmp6VisorBusqueda_seguimiento_despacho]").attr("placeholder", "DIGITE");
                $("[name=cmp7VisorBusqueda_seguimiento_despacho]").attr("placeholder", "DIGITE");
			});
			
			function abrirFormulario(){
				var row = $('#tblVisorBusqueda_seguimiento_despacho3').datagrid('getSelected');
				if (row){
						var p = $('#layoutBusquedaNormal_seguimiento_despacho3').layout('panel','center');
						p.panel('refresh','seguimiento_despacho/src/contenido/admin/perfilesusuadd.php?_id_registro_seguimiento='+row.cmp0VisorBusqueda_seguimiento_despacho);
				}else{
