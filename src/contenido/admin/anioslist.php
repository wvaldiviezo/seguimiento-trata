...
<div id="layoutBusquedaNormal_seguimiento_despacho5" class="easyui-layout" data-options="fit:true">
 ...
 <?php
   $respuesta='<table url="'.DIR_LOCAL_DATAGRID_SEGUIMIENTO_DESPACHO.'dtg_Anios.php" id="tblVisorBusqueda_seguimiento_despacho5" style="width:100%;height:100%"
	 ...
	 ">
		<thead>
			<tr >
				...
				<th data-options="field:\'cmp1VisorBusqueda_seguimiento_despacho\'" style="width:75%"><b>Año</b></th>
			</tr>
		</thead>
	...
	.datagrid-btable{
		width:100%;
         ...
         <script>
			...
			$(function (){
				$('#tblVisorBusqueda_seguimiento_despacho5').datagrid({striped:$(this)});
				//$('#tblVisorBusqueda_seguimiento_despacho').datagrid('regionSelect');
				$('#tblVisorBusqueda_seguimiento_despacho5').datagrid('getPanel').removeClass('lines-both lines-no lines-right lines-bottom').addClass("lines-no");
				$('#tblVisorBusqueda_seguimiento_despacho5').datagrid('enableFilter', [
			...
			function abrirFormulario(){
				var row = $('#tblVisorBusqueda_seguimiento_despacho5').datagrid('getSelected');
				if (row){
						var p = $('#layoutBusquedaNormal_seguimiento_despacho5').layout('panel','center');
						p.panel('refresh','seguimiento_despacho/src/contenido/admin/aniosadd.php?_id_registro_seguimiento='+row.cmp0VisorBusqueda_seguimiento_despacho);
				}else{
